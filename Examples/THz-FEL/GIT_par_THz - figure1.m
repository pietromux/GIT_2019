...
git_par.rxbeam = 120.00e-6;   % Matched beam radius (quadrupole_lattice = 0)
git_par.rybeam = 120.00e-6;   % Matched beam radius
...
git_par.lambda_w0 = 0.06;
git_par.npart = 2048;
git_par.gamma0 = 94.13;  
...
git_par.lambda = 0.113e-3;
git_par.zrayl =  0.0608;
git_par.zwaist = 0.00;
git_par.nwig = 1;
git_par.ncar = 151;
git_par.dgrid = 0.8e-3;
git_par.nscz = 0;
git_par.nscr = 0;
...
for j1 = 1:nd
 for kk = 1:nlam
tic
    git_par.dgrid = 0.8e-3+j1*0.00005;
    git_par.lambda = 0.05e-3 + 2e-6*kk;
    git_par.aw0 = 5.602/1.414;
...
%%
[mgla,mggr] = meshgrid(la(1):la(end),gr(1):gr(end));
surf(mgla,mggr,res)
%GIT_fun_output;
