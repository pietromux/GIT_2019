...
git_par.psi_0 = 1.1;               % resonant phase
...
git_par.rxbeam = 43.00e-6;   % Matched beam radius (quadrupole_lattice = 0)
git_par.rybeam = 43.00e-6;   % Matched beam radius
...
git_par.nwig=1;
git_par.awd = 2.82;
git_par.z_stop =git_par.lambda_w0*120;          % Simulation length
GIT_fun_2019;
p_rad_1=power(:,end);
GIT_fun_output;
%%
z = (1:121)*git_par.lambda_w0;
figure(300)
plot(z,phislice)
hold on
plot(z,bunchphases)
plot(z,bunchphases+phislice)
mean(bunchphases+phislice)
