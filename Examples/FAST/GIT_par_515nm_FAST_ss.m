...
git_par.prad0 = 1e0;    
git_par.parallel = 0;            % 1 parallel ; 0 single processor. Note: parallel requires mpi installation
...
% transverse matching should be calculated separately.   
%%% 12T/m 160T/m parameter

git_par.rxbeam_match=254.5e-06;
git_par.rybeam_match=283.7e-06;
git_par.alphax=1.837;
git_par.alphay=3.184;
...
%% Time-dependent options: Gaussian/rectangular beam
git_par.nslice=400;
...
git_par.psi_0 = 0;            
totalmagfilename=['mg_pbFAST.mag.in'];
...
totalmagfilename=['mg_FAST.mag.in'];
copyfile(totalmagfilename,[dirname,'mg.mag.in']);
readin_totalmagfile;
prebunched = 1;
git_par.nwig=1;
